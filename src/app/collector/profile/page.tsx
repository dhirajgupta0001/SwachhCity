  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">View your operational identity details.</p>
      </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center gap-4 pb-4">
          ...
          <div>
            <CardTitle>{profile?.full_name || "Collector"}</CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              <span className="text-sm font-medium text-muted-foreground">Operational Role</span>
